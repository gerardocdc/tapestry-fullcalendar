 ...
 */
public class ButtonWeek extends AbstractButton
{
	/*-------------------------
	|      M E T H O D S      |
	==========================*/
	...
	{
		return CalendarConstants.CALENDAR_BUTTON_FUNCTION_WEEK;
	}
	...
	{
		return (getText() != null) ? getText() : getMessages().get("calendar.button.week");
	}
}